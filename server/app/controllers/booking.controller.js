...
const getBookingByCustomer = catchAsync(async (req, res)=> {
    const booking = await bookingService.getBookingByCustomer(req.user._id,req.params);
...
const getBookingsListByCustomer = catchAsync(async (req, res)=> {
    const bookings = await bookingService.getBookingsListByCustomer(req.query,req.user._id);
